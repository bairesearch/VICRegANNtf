...
def neuralNetworkPropagationLREANN_expCUANNtrain(x, y, networkIndex=1):	#currentClassTarget
...
def generateTFtrainDataFromNParraysLREANN_expCUANN(train_x, train_y, shuffleSize, batchSize, datasetNumClasses):
