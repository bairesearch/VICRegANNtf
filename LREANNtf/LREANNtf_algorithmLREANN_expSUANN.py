"""LREANNtf_algorithmLREANN_expSUANN.py
...
# Description:
LREANNtf algorithm LREANN expSUANN - define learning rule experiment artificial neural network with stochastic update
